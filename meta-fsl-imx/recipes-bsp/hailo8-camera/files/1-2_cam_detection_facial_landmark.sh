...
function init_variables() {
    ...
    readonly DETECTION_INPUT2="rtsp://admin:Advantech@192.168.1.109:554/cam/realmonitor?channel=1\&subtype=1"

    # Webcam/RTSP for Facial Landmark
    readonly FACIAL_LANDMARK_INPUT0="rtsp://admin:Advantech@192.168.1.107:554/cam/realmonitor?channel=1\&subtype=1"
    ...
    compositor_locations2="sink_0::xpos=0 sink_0::ypos=40 sink_1::xpos=650 sink_1::ypos=0"
    compositor_locations4="sink_0::xpos=0 sink_0::ypos=40 sink_1::xpos=650 sink_1::ypos=0 \
                            sink_2::xpos=0 sink_2::ypos=680 sink_3::xpos=650 sink_3::ypos=640"
    ...
    compositor_locations="sink_0::xpos=0 sink_0::ypos=40 sink_1::xpos=640 sink_1::ypos=0 sink_2::xpos=1280 sink_2::ypos=40 sink_3::xpos=1920 sink_3::ypos=0 sink_4::xpos=0 sink_4::ypos=680 sink_5::xpos=640 sink_5::ypos=640 sink_6::xpos=1280 sink_6::ypos=680 sink_7::xpos=1920 sink_7::ypos=640"
