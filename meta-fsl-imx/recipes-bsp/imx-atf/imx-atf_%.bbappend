...
SRC_URI:append:imx8mmebcrs12a1 = " ${@bb.utils.contains_any('UBOOT_CONFIG', '4G FSPI_4G', ' file://0001-add-imx8mm-rs12a1-uartM4-support.patch ', ' file://0001-add-imx8mm-rs12a1-uartM4-support.patch ', d)} "
