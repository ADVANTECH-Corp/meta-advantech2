...
SRC_URI:append:imx8mprom5722a1 = "${@bb.utils.contains_any('UBOOT_CONFIG', '6G FSPI_6G', ' file://0001-add-imx8mp-rom5722a1-6G-support.patch ', '', d)}"
...
SRC_URI:append:imx8mmrsb3730a2 = "${@bb.utils.contains_any('UBOOT_CONFIG', '2G FSPI_2G', ' file://0001-add-imx8mm-rsb3730a2-2G-support.patch ', '', d)}"
SRC_URI:append:imx8mmrsb3730a2 = "${@bb.utils.contains_any('UBOOT_CONFIG', '4G FSPI_4G', ' file://0001-add-imx8mm-rsb3730a2-4G-support.patch ', '', d)}"
