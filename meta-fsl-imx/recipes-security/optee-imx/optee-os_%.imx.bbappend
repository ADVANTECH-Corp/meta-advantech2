...
SRC_URI:append:imx8mpepcr5710a1 = "${@bb.utils.contains_any('UBOOT_CONFIG', '2G FSPI_2G', ' file://0001-add-imx8mp-epcr5710a1-2G-support.patch ', '', d)}"
SRC_URI:append:imx8mpepcr5710a1 = "${@bb.utils.contains_any('UBOOT_CONFIG', '4G FSPI_4G', ' file://0001-add-imx8mp-epcr5710a1-4G-support.patch ', '', d)}"
SRC_URI:append:imx8mpepcr5710a1 = "${@bb.utils.contains_any('UBOOT_CONFIG', '6G FSPI_6G', ' file://0001-add-imx8mp-ecpr5710a1-6G-support.patch ', '', d)}"
