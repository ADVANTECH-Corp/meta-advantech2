...
SRC_URI_append_imx8mmrom5721a1 += "${@bb.utils.contains_any('UBOOT_CONFIG', '4G FSPI_4G', 'file://0001-add-imx8mm-rom5721a1-4G-support.patch', '', d)}"
...
SRC_URI_append_imx8mprsb3720a1 += "${@bb.utils.contains_any('UBOOT_CONFIG', '8G FSPI_8G', 'file://0005-add-imx8mp-rsb3720a1-8G-support.patch', '', d)}"
...
SRC_URI_append_imx8mprom5722a1 += "${@bb.utils.contains_any('UBOOT_CONFIG', '8G FSPI_8G', 'file://0006-add-imx8mp-rom5722a1-8G-support.patch', '', d)}"
